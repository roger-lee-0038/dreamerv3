...
if __name__ == '__main__':
    ...
    np.savetxt("resXdf1residual.txt", res.X)
    np.savetxt("resFdf1residual.txt", res.F)
    np.savetxt("allXdf1residual.txt", np.array(all_X))
    np.savetxt("allFdf1residual.txt", np.array(all_F))
    with open("histFdf1residual.pkl", "wb") as handler:
